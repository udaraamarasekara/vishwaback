...
class UserPolicy
{
    ...
    public function view(User $user)
    {
        ...
        {
            UserAbility::where([['table','user'],['method','view'],['profession_id',$profession]])->first()?->ability===1 && $ability=true;
        }
    ...
    public function create(User $user)
    {
        ...
        foreach($professions as $profession)
        {
            UserAbility::where([['table','user'],['method','create'],['profession_id',$profession]])->first()?->ability===1 && $ability=true;
        }
    ...
    {   $ability=false;
        ...
        foreach($professions as $profession)
        {
            UserAbility::where([['table','user'],['method','edit'],['profession_id',$profession]])->first()?->ability===1 && $ability=true;
        }
        return $ability===true || $user->role==='admin';
    ...
    public function delete(User $user)
    {
        ...
        foreach($professions as $profession)
        {
            UserAbility::where([['table','user'],['method','delete'],['profession_id',$profession]])->first()?->ability===1 && $ability=true;
        }
        return $ability===true || $user->role==='admin';
